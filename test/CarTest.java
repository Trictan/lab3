...
class CarTest {
    ...
    void volvo240_getters() {
        Volvo240 myVolvo = new Volvo240(new Color(255,0,0,0), new P2D(0,0));
        ...
        assertEquals(0, myVolvo.getDirection());
    }

    @Test
    void saab95_getters() {
        Saab95 mySaab = new Saab95(new Color(0,255,0,0), new P2D(0,0));
        ...
        assertEquals(0, mySaab.getDirection());
    }
    ...
    void volvo240_turn_LR() {
        Volvo240 myVolvo = new Volvo240(new Color(255,0,0,0), new P2D(0,0));
        for (var i=0; i<9;i++) {myVolvo.turnLeft();}
    ...
    void volvo240_move_forward() {
        ...
        assertEquals(new P2D(100,0), myVolvo.getPosition());
    }
    ...
    void volvo240_move_diagonal() {
        ...
        assertEquals(70.7106, myVolvo.getPosition().getX(),0.001);
        assertEquals(70.7106, myVolvo.getPosition().getY(),0.001);
    }

    @Test
    void scania_getters() {
        Scania myScania = new Scania(new Color(255,0,0,0), new P2D(0,0));
        assertEquals(2, myScania.getNrDoors());
        assertEquals(80, myScania.getEnginePower(), 0.01);
    ...
    void scania_incline_while_gas() {
        Scania myScania = new Scania(new Color(255,0,0,0), new P2D(0,0));
        myScania.gas(0.5);
        assertEquals(0.4, myScania.getCurrentSpeed(), 0.01); // moving
    ...
    @Test
    void cc() {
        CarCarrier myCC = new CarCarrier(new Color(255,0,0,0), "MAN", 3, new P2D(0,0));
        CarCarrier myCC2 = new CarCarrier(new Color(255,0,0,0), "MAN", 2, new P2D(0,0));
        Saab95 mySaab1 = new Saab95(new Color(255,0,0,0), new P2D(0,0));
        Saab95 mySaab2 = new Saab95(new Color(0,255,0,0), new P2D(0,0));
        Saab95 mySaab3 = new Saab95(new Color(0,0,255,0), new P2D(0,0));
        Volvo240 myVolvo = new Volvo240(new Color(0,0,0,0), new P2D(0,0));
        ...
        Workshop<Car> myWorkshop = new Workshop<Car>(3, new P2D(0,0), whitelist);
